                ...
                <Command.List className="max-h-[300px] overflow-y-auto p-2">
                    ...
                    <Command.Group heading="Navigation" className="text-xs font-semibold text-gray-500 dark:text-gray-400 p-2">
                        <Command.Item 
                            ...
                            className="px-2 py-2 mt-1 cursor-pointer rounded-md flex items-center text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 aria-selected:bg-indigo-50 aria-selected:text-indigo-600 dark:aria-selected:bg-indigo-500/20 dark:aria-selected:text-indigo-300"
                        >
                            Dashboard
                        </Command.Item>
                        <Command.Item 
