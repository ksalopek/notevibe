...
export default function NoteCard({ note, startEditing, deleteNote, togglePin, toggleArchive, handleTagClick, updateNoteContent, moveNote, isSelected = false, onSelect = null }) {
    ...
    }, [localContent, note.link_previews]);
                ...
                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity z-30">
                    <Tooltip content={note.is_pinned ? "Unpin" : "Pin"}>
                        <button 
                            ...
                            className={`p-1.5 rounded-full transition-all duration-200 border shadow-md hover:shadow-lg ${note.is_pinned ? 'bg-primary-100 dark:bg-primary-900/70 text-primary-600 border-primary-200 dark:border-primary-700' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-600'}`}
                        >
                    ...
                    <Tooltip content="Edit">
                        <button 
                            ...
                            className="p-1.5 bg-white hover:bg-primary-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-primary-600 dark:text-primary-400 rounded-full transition-all duration-200 border border-gray-200 dark:border-gray-600 shadow-md hover:shadow-lg"
                        >
                    ...
                    <Menu as="div" className="relative inline-block text-left">
                        <Tooltip content="More Options">
                            <Menu.Button className="p-1.5 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600 rounded-full transition-all duration-200 shadow-md hover:shadow-lg">
