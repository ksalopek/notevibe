                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            ...
                                            >
                                                <img src={getAvatar(user.name)} alt={user.name} className="w-6 h-6 rounded-full mr-2 shadow-sm border border-gray-200 dark:border-gray-700" />
                                                {user.name}
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        <div className="px-4 flex items-center gap-3">
                            <img src={getAvatar(user.name)} alt={user.name} className="w-10 h-10 rounded-full shadow-sm border border-gray-200 dark:border-gray-700" />
                            <div>
